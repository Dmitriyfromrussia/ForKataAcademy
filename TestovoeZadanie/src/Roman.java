public class Roman {
    static String[] romanDataArray = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII",
    ...
    public static boolean isRoman(String g) {
        for (int i = 0; i < romanDataArray.length; i++) {
            if (g.equals(romanDataArray[i])) {
                return true;
            }
        }
        return false;
    ...
    public static int convertToArabian(String roman) {
        for (int i = 0; i < romanDataArray.length; i++) {
            if (roman.equals(romanDataArray[i])) {
                return i;
            }
        }
        return 0; //???
